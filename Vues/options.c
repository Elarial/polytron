...
MENU_OPTIONS initMenuOptions(SDLcontext *context){
    ...
    TEXT returnValue = initTexte("RETOUR",fontFile,defaultColor,fontSize,*(context->renderer));
    ...
    returnValue.textRect.y=300,returnValue.textRect.x=0;

    MENU_OPTIONS menuOptions = {backgroundTexture,fontFile,defaultColor,selectedColor,optionsTitle,speedSelectTitle,speedSelectValue,keySelectTitle,keySelectValue,returnValue};
    return menuOptions;
